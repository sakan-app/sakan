...
export const adminStrings: FeatureDictionary<AdminStrings> = {
  ...
  fr: {
    ...
    common: {
      ...
      id: "ID",
      createdAt: "Créé le",
      unauthorizedRedirect: "Vous n'avez pas accès au panneau d'administration.",
    },
    dashboard: {
      title: "Tableau de bord admin",
      subtitle: "Vue d'ensemble de la santé et de l'activité de la plateforme.",
      usersTotal: "Total des utilisateurs",
      usersNew7d: "Nouveaux utilisateurs (7j)",
      usersActive24h: "Actifs en 24h",
      revenueThisMonth: "Revenus ce mois-ci",
      reportsOpen: "Signalements ouverts",
      verificationsPending: "Vérifications en attente",
      messages7d: "Messages envoyés (7j)",
      subscriptionsByPlan: "Abonnements par offre",
      signupsChart: "Inscriptions quotidiennes",
      revenueChart: "Revenus quotidiens",
    },
    users: {
      title: "Utilisateurs",
      subtitle: "Gérer les comptes, rôles et statuts.",
      searchPlaceholder: "Rechercher par nom…",
      filterStatus: "Statut",
      filterVerified: "Vérification",
      active: "Actif",
      suspended: "Suspendu",
      verified: "Vérifié",
      ...
      ban: "Bannir",
      banConfirm: "Bannir définitivement cet utilisateur ?",
      suspendReason: "Motif (facultatif)",
    ...
    userDetail: {
      ...
      subscription: "Abonnement",
      payments: "Paiements",
      reportsFiled: "Signalements déposés",
      reportsAgainst: "Signalements reçus",
      grantRole: "Accorder un rôle",
      revokeRole: "Révoquer un rôle",
    ...
    verification: {
      ...
      subtitle: "Examinez les documents d'identité et les selfies.",
      pending: "En attente",
      approved: "Approuvé",
      rejected: "Rejeté",
      approve: "Approuver",
      ...
      document: "Document",
      selfie: "Selfie",
      noRequests: "Aucune demande de vérification.",
    },
    reports: {
      title: "Signalements",
      subtitle: "Examinez les signalements des utilisateurs et agissez.",
      open: "Ouvert",
      ...
      flagsTitle: "Signalements automatiques de modération",
      flagsSubtitle: "Contenu signalé automatiquement pour examen.",
      flagged: "Signalé",
      approve: "Approuver",
      reject: "Rejeter",
      subjectType: "Type de contenu",
      excerpt: "Extrait",
      noFlags: "Aucun signalement de modération.",
    },
    subscriptions: {
      title: "Abonnements et paiements",
      subtitle: "Suivez les abonnements actifs et l'historique des paiements.",
      plan: "Offre",
      status: "Statut",
    ...
    audit: {
      ...
      subtitle: "Un historique de toutes les actions administratives.",
      action: "Action",
      ...
      filterAdmin: "Filtrer par administrateur",
    },
    roles: {
      title: "Gestion des rôles",
      subtitle: "Accordez ou révoquez les rôles d'administrateur et de modérateur.",
      userIdPlaceholder: "ID utilisateur (UUID)",
      grant: "Accorder",
      revoke: "Révoquer",
      adminOnlyNotice: "Cette page est réservée aux administrateurs.",
    },
  },
};
